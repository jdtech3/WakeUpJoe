...
public class MainActivity extends AppCompatActivity implements Runnable {
    ...
    private final static String IP = "192.168.205.142";
    ...
    private Runnable mRunnable = new Runnable() {
        ...
        public void run() {
            ...
            MainActivity.this.runOnUiThread(
                () -> {
                    mButton.setText(String.format("Listening... (%ds)", mStart));
                    mStart += 1;
            });
        }
    };
    ...
    private void requestInternetPermission() {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
            requestPermissions(new String[]{android.Manifest.permission.INTERNET}, 14);
        }
    }
    ...
    private void sendRequest(String command) {
        String url = "http://" + IP + ":5000/command/" + command;
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.GET, url,
            new Response.Listener<String>() {
                ...
                public void onResponse(String response) {
                    mTextView.setText(mTextView.getText() + "; Response is: " + response);
                }
            }, new Response.ErrorListener() {
                @Override
                public void onErrorResponse(VolleyError error) {
                    mTextView.setText(mTextView.getText() + "; Got error!" + error.toString());
                }
            }
        );
